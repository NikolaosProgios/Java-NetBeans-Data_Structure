...
class LaboratoryCourse{
    ...
    public LaboratoryCourse(int arthTmimaton){
        labs=new Lab[arthTmimaton];
    }
    
    public LaboratoryCourse(String mathima,int arthTmimaton){
        this.mathima=mathima;
        labs=new Lab[arthTmimaton];
    }
    
    public LaboratoryCourse(String mathima,Lab[] l){
        this.mathima=mathima;
        labs=l;
    }
	*/
